...
limb_seq = [[1,2], [2,3], [3,4], [4,5], [2,6], [6,7], [7,8], [2,9], [9,10], [10,11], [9,3], [2,12], [12,13], [13,14],
           [9,12], [2,17], [2,18], [1,17], [1,18], [1,15], [1,16], [15,17], [16,18]]
...
def get_mask(skeleton_pose):
    return erosion(dilation(skeleton_pose, square(20)), square(20))
...
cv2.imwrite(os.path.join(skeleton_pose_path, 'skeleton1.jpg'))
pose_mask = get_mask(skeleton_pose)
cv2.imwrite(os.path.join(pose_mask_path, 'mask1.jpg'))
